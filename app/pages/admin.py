...
def admin_page():
    ...
    with ui.dialog() as tournament_dialog, ui.card().classes("w-[1100px] max-w-full"):
        ...
        with ui.tab_panels(tournament_tabs, value=tab_info).classes("w-full"):
            ...
            with ui.tab_panel(tab_teams):
                ...
                team_selection_container = ui.column().classes("w-full gap-4 overflow-auto")
            ...
            with ui.tab_panel(tab_players):
                ...
                player_selection_container = ui.column().classes("w-full gap-4 overflow-auto")
